...
public class DtcutiKhususController {
    ...
    public boolean saveOrEdit(String idDetailKhusus, String status, CutiKhusus idCutiKhusus, Karyawan idKaryawan){
        Dtcutikhusus dtcutikhusus = new Dtcutikhusus(idDetailKhusus, status, idCutiKhusus, idKaryawan);
